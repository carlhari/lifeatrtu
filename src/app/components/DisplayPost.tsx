  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 16; i++) {
      divs.push(
        <div
          key={i}
          className="relative break-inside-avoid mb-4 p-2 rounded-xl bg-slate-400/80 shadow-sm opacity-50"
          style={{
            width: "100%",
          }}
        >
  ...
  return (
    hydrate && (
      <>
        ...
        {loading ? (
          <div className="columns-4 gap-4 mb-4 p-1">{skeleton}</div>
        ) : (
